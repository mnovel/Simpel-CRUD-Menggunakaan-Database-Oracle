...
<head>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>template/assets/compiled/css/auth.css" />
</head>
    ...
    <div id="auth">
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="index.html"><img src="<?= BASE_URL ?>template/assets/compiled/svg/logo.svg" alt="Logo" /></a>
                    </div>
